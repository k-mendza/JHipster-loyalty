...
import { EventAttendanceComponent } from 'app/entities/event-attendance/event-attendance.component';
...
describe('Component Tests', () => {
    describe('EventAttendance Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.eventAttendances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

...
import com.d3v4.loyalty.domain.Location;
import com.d3v4.loyalty.repository.LocationRepository;
import com.d3v4.loyalty.service.LocationService;
import com.d3v4.loyalty.service.dto.LocationDTO;
import com.d3v4.loyalty.service.mapper.LocationMapper;
...
public class LocationResourceIntTest {
    ...
    private static final Integer DEFAULT_RUN_DAY = 1;
    private static final Integer UPDATED_RUN_DAY = 2;
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getRunDay()).isEqualTo(DEFAULT_RUN_DAY);
    }
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].runDay").value(hasItem(DEFAULT_RUN_DAY)));
    }
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.runDay").value(DEFAULT_RUN_DAY));
    }
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getRunDay()).isEqualTo(UPDATED_RUN_DAY);
    }
